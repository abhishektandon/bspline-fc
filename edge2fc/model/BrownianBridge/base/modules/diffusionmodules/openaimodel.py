...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None,**kwargs):
        ...
        if self.condition_key != 'nocond':
            # changes: .save
            # print(self.condition_key)
            # to_pil = transforms.ToPILImage()
            # r = random.randint(1, 99999)
            # x_image = to_pil(x[0])
            # context_image = to_pil(context[0])
            
            # x_image.save(f'/scratch/abhishekt.scee.iitmandi/abhishek/diffusion/BBDM/visualize/x2_{r}.png')
            # context_image.save(f'/scratch/abhishekt.scee.iitmandi/abhishek/diffusion/BBDM/visualize/context_{r}.png')
